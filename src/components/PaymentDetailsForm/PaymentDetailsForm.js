...
class PaymentDetailsForm extends React.Component {
    constructor() {
        ...
        this.cciconRef = React.createRef();
        this.ccsingleRef = React.createRef();
        this.state = {
            amount: '',
            cardNo: '',
            cvv: '',
    ...
    componentDidMount() {
        window.addEventListener('load', () => {
            handleLoad(this.amountRef.current, this.nameRef.current, this.cardnumberRef.current, this.expirationdateRef.current, this.securitycodeRef.current, this.cciconRef.current, this.ccsingleRef.current);
        });
    }
            ...
            <div>
                ...
                <div className="container preload">
                    <div className="creditcard">
                        <div className="front">
                            <div id="ccsingle" ref={this.ccsingleRef}></div>
